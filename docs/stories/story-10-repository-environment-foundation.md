...
- [x] **Code Quality**: Black, Pylint (≥8.5), mypy, isort pass without errors (N/A - no Python code in this story)
- [x] **Documentation**: All functions have Google-style docstrings with type hints (N/A - no Python code in this story)
