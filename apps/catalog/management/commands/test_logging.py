...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options) -> None:
        ...
        self.stdout.write(self.style.SUCCESS("OK - Console output: Hierarchical tree with Unicode box-drawing"))
        self.stdout.write(self.style.SUCCESS("OK - File output: Structured JSON at logs/samplify.log"))
        self.stdout.write(self.style.SUCCESS("OK - Exception hook: Installed for uncaught exceptions"))
        self.stdout.write(self.style.SUCCESS("OK - Context styling: URLs, IPs, emails, file paths"))
        self.stdout.write(self.style.SUCCESS("="*80))
